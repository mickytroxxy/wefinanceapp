    ...
    return (
        <>
            <Box textAlign='center'>
                ...
                <Button onClick={()=> !mobileView ? setDialogData({visible:true,title:'WITHDRAW YOUR FUNDS',data:{isSuccess:false,amount:0}}) : navigate("mobile",{page:'WITHDRAW YOUR FUNDS',data:{isSuccess:false,amount:0}})} variant="contained" style={{backgroundColor:'green',color:'#fff'}}  component="label"startIcon={<AtmIcon style={{fill: "#fff"}}/>}>
